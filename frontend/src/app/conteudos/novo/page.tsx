...
import { getPersonas, getPadroes, generateContent } from '@/lib/api';
import { Check, ChevronRight, Loader2, Plus } from 'lucide-react';

type Step = 'persona' | 'padrao' | 'tema' | 'gerar';
const STEPS: Step[] = ['persona', 'padrao', 'tema', 'gerar'];
const STEP_LABELS: Record<Step, string> = { persona: 'Persona', padrao: 'Padrão', tema: 'Tema', gerar: 'Gerar' };
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-1">Siga os passos para gerar seu carrossel</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-6">
        {step === 'persona' && (
          <div>
            ...
            <p className="text-sm text-gray-500 mb-5">Escolha o perfil do público-alvo</p>
